...
TestCrop() {
    RunTest "gm convert INPUT -crop 100x100+10+10 OUTPUT" "crop"
}

# Test compression functionality
TestCompress() {
    RunTest "gm convert INPUT -quality 90 OUTPUT" "compress"
}

# Test resize functionality
TestResize() {
    RunTest "gm convert INPUT -resize 50% OUTPUT" "resize"
}

# Test image format conversion
TestConvert() {
    RunTest "gm convert INPUT OUTPUT" "convert"
}
